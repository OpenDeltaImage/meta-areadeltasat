...
# Use the AREADELTASAT download servers, regardless of where we are. Even for "private" feeds
DISTRO_FEED_PREFIX = "areadeltasat"
...
DISTRO_FEED_URI = "http://download.areadeltasat.net/feed-arm"
